  ...
  return (
    <Layout title={title} user={user}>
      <div className="main_map">
        <div className="china" title="китайский">
        ...
        <div className="taiwan">
          <a href="/taiwan">Тайвань</a>
        </div>
        <div className="australia">
          <a href="/australia">Австралия</a>
        </div>
        <div className="kenia">
          <a href="/kenia">Кения</a>
        </div>
        <div className="azorskieOstrova">
          <a href="/azorskieOstrova">Азорские острова</a>
        </div>
        <div className="ekvador">
          <a href="/ekvador">Эквадор</a>
        </div>
        <div className="peru">
          <a href="/peru">Перу</a>
        </div>
